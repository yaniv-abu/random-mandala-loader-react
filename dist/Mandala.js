...
import './Mandala.css';
export default function RandomMandalaLoader({
  animate = true,
  clickToRegenerate = true
}) {
  ...
  if (clickToRegenerate) svgProps = { ...svgProps,
    className: svgProps.className + " clickable",
    onClick: forceUpdate
  };
  return /*#__PURE__*/React.createElement("svg", _extends({
    viewBox: "0 0 100 100"
  }, svgProps), /*#__PURE__*/React.createElement("circle", {
    key: "center",
...
function generateMandalaCircles() {
  ...
  while (inBounds) {
    ...
    if (shapeBounds) {
      ...
      const currentCircle = /*#__PURE__*/React.createElement(MandalaCircle, _extends({}, circleProps, {
        key: circleIndex
      }));
...
function animateSpinningCircles(circlesArray) {
  ...
  for (let i = 0; i < numberOfSpinningCircles; i++) {
    ...
    circlesArray[randomIndex] = React.cloneElement(circlesArray[randomIndex], {
      style
    });
  }
}